...
import { getHentaiManifestCatalogs, getSukebeiManifestCatalogs } from './utils/externalCatalogs';
...
async function buildManifest(cfg: AddonConfig, baseUrl: string) {
  ...
  const catalogs = [...tpbCatalogs, ...pornSearchCatalogs, ...pornripsCatalogs, ...hentaiCatalogs, ...sukebeiCatalogs, ...categoryCatalogs];

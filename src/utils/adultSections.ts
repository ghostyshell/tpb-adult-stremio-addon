...
const STUDIO_PRESETS = [
  ...
  // fresh page-1 results. Joins the existing Gay group above.
  'BoyFun', 'CockyBoys', 'Staxus', 'Latin Boyz', 'Hardkinks', 'Why Not Bi',
  // VR studios - VR is high-res so most have both 4K (507) and 1080p (505).
  // Verified on thehiddenbay.com; NaughtyAmericaVR has no 4K results (1080p-only).
  'VRBangers', 'BadoinkVR', 'VirtualRealPorn', 'SexLikeReal', 'CzechVR',
  'WankzVR', 'NaughtyAmericaVR', 'VRHush', 'DarkRoomVR', 'MilfVR',
  'RealJamVR', 'VRAllure',
  // Ebony studios (Black-women brands). Only BrownBunnies has 4K results; the
  // rest are 1080p-only. Interracial brands (BlacksOnBlondes, DarkX) are NOT
  // ebony and are excluded. Verified on thehiddenbay.com.
...
const GAY_STUDIOS = new Set([
  'SketchySex', 'TimTales', 'ChaosMen',
  'Men.com', 'Sean Cody', 'Helix Studios', 'Falcon Studios',
  // Added gay-male studios (HD 505, 1080p-only), verified on thehiddenbay.com
  'BoyFun', 'CockyBoys', 'Staxus', 'Latin Boyz', 'Hardkinks', 'Why Not Bi',
]);
...
// VR studios - VR is high-res, so most have both 4K (507) and 1080p (505)
// results on thehiddenbay.com; NaughtyAmericaVR is 1080p-only.
const VR_STUDIOS = new Set([
  'VRBangers', 'BadoinkVR', 'VirtualRealPorn', 'SexLikeReal', 'CzechVR',
  'WankzVR', 'NaughtyAmericaVR', 'VRHush', 'DarkRoomVR', 'MilfVR',
  'RealJamVR', 'VRAllure',
]);
...
// Ebony studios - Black-women brands. Only BrownBunnies has 4K results; the
// rest are 1080p-only. Interracial brands are NOT classified as ebony.
const EBONY_STUDIOS = new Set([
  'RoundAndBrown', 'BrownBunnies', 'GhettoGaggers', 'We Fuck Black Girls',
  'Gloryhole Initiations', 'WatchingMyMomGoBlack', 'Cumbang',
  'BlackValleyGirls', 'Evasive Angles', 'West Coast Productions',
  'Black Ice', 'Pinkyxxx',
...
function studioOrientation(studio: string) {
  ...
  if (VR_STUDIOS.has(studio))             return 'vr';
  if (EBONY_STUDIOS.has(studio))          return 'ebony';
...
export { getHbParams, getCatalogBases, getConfiguredSources, STUDIO_PRESETS, LOGICAL_CATALOGS, QUALITIES_DEFAULT as QUALITIES, GAY_STUDIOS, LESBIAN_STUDIOS, TRANS_STUDIOS, VR_STUDIOS, EBONY_STUDIOS, JAV_CENSORED_STUDIOS, JAV_UNCENSORED_STUDIOS, studioOrientation, studioSafeId, SOURCES, ADULT_WEBSITE, };
